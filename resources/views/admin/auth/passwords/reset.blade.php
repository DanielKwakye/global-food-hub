                            ...
                            <div class="card border-grey border-lighten-3 px-2 py-2 m-0">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" method="post" action="{{ url('/admin/password/reset') }}" novalidate>
                                            {{csrf_field()}}
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                                    <input type="email" class="form-control form-control-lg" value="{{old('password')}}" id="user-email" name="password" placeholder="Your Password">
                                                    <div class="form-control-position">
                                                        <i class="ft-mail"></i>
                                                    </div>
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                                    <input type="email" class="form-control form-control-lg" value="{{old('email')}}" id="user-email" name="password_confirmation" placeholder="Confirm Password">
                                                    <div class="form-control-position">
                                                        <i class="ft-mail"></i>
                                                    </div>
